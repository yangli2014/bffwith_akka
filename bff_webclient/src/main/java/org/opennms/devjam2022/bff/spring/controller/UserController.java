...
public class UserController {
  ...
  @GetMapping("/{id}")
  public Mono<JsonNode> getUserByID(@PathVariable String id) {
    return service.getUserByID(id);
  }

  @PostMapping
  public Mono<JsonNode> createUser(@RequestBody String data) {
    return service.createUser(data);
  }

  @DeleteMapping("/{id}")
  public Mono<JsonNode> deleteUser(@PathVariable String id) {
